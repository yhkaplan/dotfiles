...
# Requires absolute path! https://github.com/unsignedinteger/deckset-scripts/issues/3
# By https://github.com/infinitesteps, retreived from https://github.com/unsignedinteger/deckset-scripts
